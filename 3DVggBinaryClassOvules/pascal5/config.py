...
config.img_path='../../pascal5/voc2012/JPEGImages/'
config.annotations_path='../../pascal5/voc2012/SegmentationClass/'
config.save_dir='./pascal5/'
config.root_dir='../data'

config.current_index=2    #0,1,2,3
