...
def trainAffPredCircles(saveToFile, device, separating_channel, offsets, strides, numEpochs=1):
    file = 'mask/masks.h5'
    ...
    for epoch in range(numEpochs):
        ...
        labels, neighbors, cutting_edges, mutexes, indices = \
        dbg_output = compute_mws_segmentation_cstm(weights, offsets, separating_channel, algorithm='prim')
