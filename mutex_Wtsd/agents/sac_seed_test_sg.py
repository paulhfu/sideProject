...
class AgentSacTrainer_test_sg(object):
    ...
    def __init__(self, cfg, args, global_count, global_writer_loss_count, global_writer_quality_count,
        ...
        super(AgentSacTrainer_test_sg, self).__init__()
    ...
    def update_critic(self, obs, action, reward, next_obs, not_done, env, model, optimizers):
        ...
        target_V = target_V[obs[4]].view(-1, self.args.s_subgraph)
        ...
        current_Q1 = current_Q1[obs[4]].view(-1, self.args.s_subgraph)
        current_Q2 = current_Q2[obs[4]].view(-1, self.args.s_subgraph)
    ...
    def update_actor_and_alpha(self, obs, env, model, optimizers):
        ...
        actor_Q = actor_Q[obs[4]].view(-1, self.args.s_subgraph)
