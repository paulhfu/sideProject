from agents.replayMemory import ReplayMemory, TransitionData
...
class QlAgent1(object):
    ...
    def store_transit(self, state, action, reward, next_state_, time, behav_probs, terminal):
        self.mem.push(state, action, reward, next_state_, time, behav_probs, terminal)
