from models.ril_function_models import DNDQNRI, UnetFcnDQN, UnetRI
import torch
...
class RIAgentMnm(object):
    def __init__(self, gamma, n_state_channels, n_actions, action_shape, device, epsilon=0.4, writer=None):
        ...
        self.policy = DNDQNRI(num_classes=n_actions, num_inchannels=n_state_channels, device=device)
