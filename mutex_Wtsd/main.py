...
parser.add_argument('--eps-final', type=float, default=0.009, metavar='eps', help='final epsilon')
...
## Optimization
parser.add_argument('--min-lr', type=float, default=0.01, metavar='η', help='min Learning rate')
parser.add_argument('--lr', type=float, default=0.06, metavar='η', help='Learning rate')
